...
misc = {
    ...
    "learn_settings_growth_strategy": "Growth strategy",
    "learn_settings_growth_strategy_info": "Select SuperBoost to quickly set ‟to review” the words you probably already know",
