...
class ApplicationAjaxCourseEditRoutesTest(SimpleTestCase):
    ...
    def test_level_add(self):
        ...
        response = self.client.request("/ajax/level/add", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'course_id': 1,
        })
    ...
    def test_level_delete(self):
        ...
        response = self.client.request("/ajax/level/delete", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'level_id': 1,
        })
        self.assertEqual(response.status_code, 200)
    ...
    def test_level_alts_edit(self):
        ...
        cookies = self.get_auth_cookies()
        response = self.client.request("/ajax/level/1/alt_edit", method="POST", headers={"Cookie": cookies.simple_output()})
        self.assertEqual(response.status_code, 400)

        response = self.client.request("/ajax/level/1/alt_edit", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'cell_id': 1,
            'alts': r'{}',
        })
        self.assertEqual(response.status_code, 200)
    ...
    def test_level_thing_add(self):
        ...
        response = self.client.request("/ajax/level/1/add", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'data': r'{}',
        })
        self.assertEqual(response.status_code, 200)
    ...
    def test_level_thing_edit(self):
        ...
        response = self.client.request("/ajax/level/1/edit", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'cell_id': 1,
            'cell_value': r'{}',
        })
        self.assertEqual(response.status_code, 200)
    ...
    def test_level_thing_remove(self):
        ...
        cookies = self.get_auth_cookies()
        response = self.client.request("/ajax/level/1/remove", method="POST", headers={"Cookie": cookies.simple_output()})
        self.assertEqual(response.status_code, 400)

        response = self.client.request("/ajax/level/1/remove", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'thing_id': 1,
        })
        self.assertEqual(response.status_code, 200)
    ...
    def test_level_media_edit(self):
        ...
        cookies = self.get_auth_cookies()
        response = self.client.request("/ajax/level/1/edit_multimedia", method="POST", headers={"Cookie": cookies.simple_output()})
        self.assertEqual(response.status_code, 400)

        response = self.client.request("/ajax/level/1/edit_multimedia", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'course_id': 1,
            'level_index': 1,
            'txt': '',
        })
    ...
    def test_level_uploadfile(self):
        ...
        cookies = self.get_auth_cookies()
        response = self.client.request("/ajax/level/1/upload", method="POST", headers={"Cookie": cookies.simple_output()})
        self.assertEqual(response.status_code, 400)

        data = '--boundary\r\nContent-Disposition: form-data; name="cell_id"\r\n\r\n3\r\n--boundary\r\nContent-Disposition: form-data; name="file"; filename="a.txt"\r\nContent-Type: text/plain\r\n\r\na\r\n--boundary--\r\n'

        response = self.client.request("/ajax/level/1/upload", method="POST", headers={
    ...
    def test_level_uploadfile_v2(self):
        ...
        cookies = self.get_auth_cookies()
        response = self.client.request("/ajax/thing/cell/upload_file", method="POST", headers={"Cookie": cookies.simple_output()})
        self.assertEqual(response.status_code, 400)

        data = '--boundary\r\nContent-Disposition: form-data; name="thing_id"\r\n\r\n1\r\n--boundary\r\nContent-Disposition: form-data; name="cell_id"\r\n\r\n3\r\n--boundary\r\nContent-Disposition: form-data; name="f"; filename="a.txt"\r\nContent-Type: text/plain\r\n\r\na\r\n--boundary--\r\n'

        response = self.client.request("/ajax/thing/cell/upload_file", method="POST", headers={
            "Cookie": cookies.simple_output(),
            "Content-Type": "multipart/form-data; boundary=boundary",
        }, data=data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_level_removefile(self):
        ...
        cookies = self.get_auth_cookies()
        response = self.client.request("/ajax/level/1/upload_remove", method="POST", headers={"Cookie": cookies.simple_output()})
        self.assertEqual(response.status_code, 400)

        response = self.client.request("/ajax/level/1/upload_remove", method="POST", headers={"Cookie": cookies.simple_output()}, data={
            'cell_id': 1,
            'file_id': 1,
        })
        self.assertEqual(response.status_code, 200)
