...
$for frame in frames:
    ...
    $if frame.context_line is not None:
        ...
        $if frame.pre_context:
            ...
            <ol start="$(frame.lineno)" class="context-line"><li onclick="toggle('pre$(frame.id)', 'post$(frame.id)')">
                $(frame.context_line) <span>...</span></li>
            </ol>
...
def get_djangoerror_template():
    return Template(new_djangoerror_t, filename=__file__, filter=websafe)
