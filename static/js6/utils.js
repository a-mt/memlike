...
var objectsAreEqual = window.objectsAreEqual = function(newObj, oldObj){
  ...
  for (const key in oldObj) {
    if (typeof newObj[key] !== typeof newObj[key]) {
      return false;
    }
    if (typeof newObj[key] === 'object') {
      return objectsAreEqual(newObj[key], oldObj[key]);
    }
...
var TTS = window.TTS = {
  ...
  getAudioURL(text, lang) {
    ...
    // return 'https://google-tts-api.herokuapp.com/?q=' + encodeURIComponent(text) + '&tl=' + lang + '&ttspeed=1&download';
  }
};
