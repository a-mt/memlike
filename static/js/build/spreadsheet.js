function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value}catch(error){reject(error);return}if(info.done){resolve(value)}else{return Promise.resolve(value).then(function(value){step('next',value)},function(err){step('throw',err)})}}return step('next')})}}var process=process||{};process.env=process.env||{};window.MEMLIKE=window.MEMLIKE||{};window.MEMLIKE.js_spreadsheet={build_date:"2026-05-12T04:44-04:00"};/* global $, window, document, console *//* global fetch */$(document).ready(function(){bindSpreadsheetEvents()});function bindSpreadsheetEvents(){var linkCourse=window.MEMLIKE.course.url,idCourse=window.MEMLIKE.course.id;// Choose to export either multimedia or classic levels
