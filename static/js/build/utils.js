...
}else{if(audioPlayer.isPlaying){audioPlayer.target.pause();audioPlayer.target.classList.remove('active')}setTimeout(function(){audioElement.play();audioElement.button.classList.add('active');audioPlayer.target=audioElement;audioPlayer.isPlaying=true},0)}},// Pause the current audio
